...
local Window = Fluent:CreateWindow({
    Title = "Cat Hub",
    SubTitle = "by: mèo béo thích macdonal",
    TabWidth = 160,
...
local Tabs = {
    ...
    ITM = Window:AddTab({ Title = "Items Farm", Icon = "sword" }),
    Setting = Window:AddTab({ Title = "Setting, Icon = "settings" }),
    Status = Window:AddTab({ Title = "Status", Icon = "user" }),
    Stats = Window:AddTab({ Title = "Stats", Icon = "plus-circle"}),
    Player = Window:AddTab({ Title = "Local Player", Icon = "baby"}),
    Teleport = Window:AddTab({ Title = "Teleport1", Icon = "palmtree"}),
    Visual = Window:AddTab({ Title = "Visual", Icon = "align-vertical-distribute-center" }),
    Fruit = Window:AddTab({ Title = "Tab Fruit", Icon = "apple" }),
    Raid = Window:AddTab({ Title = "Raid1 ", Icon = "swords" }),
