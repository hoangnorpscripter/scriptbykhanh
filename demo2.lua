...
local imgavata = Instance.new("ImageLabel")
local UICorner_2 = Instance.new("UICorner")
local decoration = Instance.new("TextLabel")
local a = Instance.new("TextLabel")
local cathub = Instance.new("ImageLabel")
local UICorner_3 = Instance.new("UICorner")
local p = Instance.new("TextLabel")
local tks = Instance.new("TextLabel")
...
local embecuaa1 = Instance.new("UIGradient")
local a2 = Instance.new("UIStroke")
...
Main.Position = UDim2.new(0.264945567, 0, 1.5, 0)
Main.Size = UDim2.new(0.468478322, 0, 0.411740929, 0)
...
embecuaa1.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(0.99, Color3.fromRGB(0, 255, 81)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
embecuaa1.Parent = a1
game:GetService("RunService").RenderStepped:Connect(function()
	embecuaa1.Rotation = embecuaa1.Rotation + 4
end)

UICorner.CornerRadius = UDim.new(0, 9)
UICorner.Parent = Main

imgavata.Name = "imgavata"
imgavata.Parent = Main
imgavata.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
imgavata.BorderColor3 = Color3.fromRGB(0, 0, 0)
imgavata.BorderSizePixel = 0
imgavata.Position = UDim2.new(0.0232017636, 0, -0.255654007, 0)
imgavata.Size = UDim2.new(0.116705291, 0, 0.193412036, 0)
imgavata.Image = "http://www.roblox.com/asset/?id=17510757535"

UICorner_2.CornerRadius = UDim.new(1, 5)
UICorner_2.Parent = imgavata

decoration.Name = "decoration"
decoration.Parent = imgavata
...
decoration.Position = UDim2.new(1.27327502, 0, 0.305032372, 0)
decoration.Size = UDim2.new(4.33503866, 0, 0.684644938, 0)
decoration.Font = Enum.Font.ArialBold
decoration.Text = "- - ! Notification ! - -"
decoration.TextColor3 = Color3.fromRGB(0, 0, 0)
decoration.TextSize = 14.000
...
a.BorderSizePixel = 0
a.Position = UDim2.new(0.316426665, 0, -12.180397, 300)
a.Size = UDim2.new(0.459585011, 0, 0.225348338, 0)
a.Font = Enum.Font.SourceSans
a.Text = "_______________________"
a.TextColor3 = Color3.fromRGB(0, 0, 0)
a.TextSize = 14.000

cathub.Name = "cathub"
cathub.Parent = Main
cathub.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
cathub.BorderColor3 = Color3.fromRGB(0, 0, 0)
cathub.BorderSizePixel = 0
cathub.Position = UDim2.new(0.052204214, 0, 0.0934119076, 0)
cathub.Size = UDim2.new(0.177610174, 0, 0.291740477, 0)
cathub.Image = "http://www.roblox.com/asset/?id=15498317188"

UICorner_3.Parent = cathub
...
p.BorderSizePixel = 0
p.Position = UDim2.new(0.395064294, 0, -0.024582101, 0)
p.Size = UDim2.new(0.365438819, 0, 0.232743397, 0)
p.Font = Enum.Font.SourceSansBold
p.Text = "Chào cả nhà | Hey everyone"
p.TextColor3 = Color3.fromRGB(0, 0, 0)
p.TextSize = 16.000

tks.Name = "tks"
tks.Parent = p
tks.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
tks.BackgroundTransparency = 1.000
tks.BorderColor3 = Color3.fromRGB(0, 0, 0)
tks.BorderSizePixel = 0
tks.Position = UDim2.new(-0.226271197, 0, 0.781581163, 0)
tks.Size = UDim2.new(0.999997735, 0, 0.691463768, 0)
tks.Font = Enum.Font.SourceSans
tks.Text = "Thank you for using script"
tks.TextColor3 = Color3.fromRGB(0, 0, 0)
tks.TextSize = 16.000
...
name.Position = UDim2.new(0.0214378145, 0, 0.353982121, 0)
name.Size = UDim2.new(0.229814157, 0, 0.208161443, 0)
name.Font = Enum.Font.SourceSansBold
name.Text = "CAT┇Quý, Khanh"
...
UIGradient.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(235, 12, 255)), ColorSequenceKeypoint.new(0.99, Color3.fromRGB(0, 255, 81)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(0, 0, 0))}
...
owner.Position = UDim2.new(-0.00306218443, 0, 0.840707839, 0)
owner.Size = UDim2.new(0.331887066, 0, 0.157325789, 0)
owner.Font = Enum.Font.SourceSansBold
owner.Text = "Owner : Quýdz"
owner.TextColor3 = Color3.fromRGB(0, 0, 0)
...
key.Position = UDim2.new(0.327689141, 0, 0.314650893, 0)
key.Size = UDim2.new(0.395064533, 0, 0.154080719, 0)
...
user.Position = UDim2.new(0.19293873, 0, 0.467059761, 0)
user.Size = UDim2.new(0.46037671, 0, 0.385152489, 0)
...
username.Position = UDim2.new(0.512218356, 0, 0.370181531, 0)
username.Size = UDim2.new(0.535609603, 0, 0.246873394, 0)
username.Font = Enum.Font.SourceSansBold
username.LineHeight = 3.000
username.Text = "tetgamebocphet"
username.TextColor3 = Color3.fromRGB(255, 255, 255)
username.TextSize = 20.000

UIGradient_2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(5, 255, 1)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 14, 243))}
UIGradient_2.Parent = username

-- Scripts:

local function UQESHN_fake_script() -- UIGradient.animation 
	...
	b.RenderStepped:Connect(function()
		a.Rotation = a.Rotation + 4
	end)
end
coroutine.wrap(UQESHN_fake_script)()
local function CICTST_fake_script() -- username.users 
	local script = Instance.new('LocalScript', username)

	-- Lấy dịch vụ Players
	local Players = game:GetService("Players")
	
	-- Lấy người chơi đang chạy
	local player = Players.LocalPlayer
	
	-- Lấy tên của người chơi và đặt nó vào TextLabel
	script.Parent.Text = "" .. player.Name
end
coroutine.wrap(CICTST_fake_script)()
local function VWGH_fake_script() -- UIGradient_2.animation 
...
coroutine.wrap(VWGH_fake_script)()
...
local function mmb()	
	...
	t:Create(Main, TweenInfo.new(0.5), {Position = UDim2.new(0.264945567, 0, 0.293522269, 0)}):Play()
	visible = true
	
	wait(4)
	
	t:Create(Main, TweenInfo.new(0.5), {Position = UDim2.new(0.264945567, 0, 1.5, 0)}):Play()
	visible = false
...
do
                        ...
                        pcall(function()
                            if plr.Character:FindFirstChildOfClass("Tool") and AC.blades and AC.blades[1] then
                                ...
                                game.ReplicatedStorage.Remotes.Validator:FireServer(
                                    math.floor(u12 / 1099511627776 * 16777215), u10)
    ...
    local ToggleCandy = Tabs.Main:AddToggle("ToggleCandy", {
        Title = "Auto Farm Candy ( Only Max Level )",
        Description = "Cày Kẹo ( Chỉ Cấp Độ Tối Đa )",
        Default = false
    })
    ...
    spawn(function()
        while wait() do
            if _G.AutoCandy then
                pcall(function()
                    toTarget(CandyPos)
                    if game:GetService("Workspace").Enemies:FindFirstChild("Isle Outlaw") or
                        ...
                        game:GetService("Workspace").Enemies:FindFirstChild("Isle Champion") then
                        for i, v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                            if v.Name == "Isle Outlaw" or v.Name == "Island Boy" or v.Name == "Sun-kissed Warrior" or
                                v.Name == "Isle Champion" then
                                if v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and
                                    v.Humanoid.Health > 0 then
                                    repeat
                                        wait(_G.Fast_Delay)
...
function Hop()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/hoangnorpscripter/scriptbykhanh/main/notificationhopping.lua"))()
    wait(6)
