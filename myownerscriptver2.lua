...
local Window = OrionLib:MakeWindow({Name = "KhnahHub", HidePremium = false, SaveConfig = true, ConfigFolder = "KhnahHubBF", IntroText = "KhnahHub", IntroEnabled = true})

local Tab = Window:MakeTab({
  Name = "Main Farm",
  Icon = "rbxassetid://15888556429",
  PremiumOnly = false
})
